    ...
    return (
      ...
      (t.prototype._getSelector = function (t, e) {
        return (
          ...
          "string" != typeof t
            ? t
            : ((e = e || document), "#" === t.substring(0, 1) ? e.querySelector(t) : e.querySelectorAll(t))
        );
      }),
      (t.prototype._each = function (t) {
        return this.selector
          ? (void 0 !== this.selector.length ? [].forEach.call(this.selector, t) : t(this.selector, 0), this)
          : this;
      }),
  ...
  var T = function (t, e, i, s) {
    ...
    F = (function () {
      function w(t, e) {
        ...
        return (
          (this.galleryItems = this.getItems()), this.normalizeSettings(), this.init(), this.validateLicense(), this
        );
      }
      return (
        ...
        (w.prototype.updateSlides = function (t, e) {
          if (
            (this.index > t.length - 1 && (this.index = t.length - 1), 1 === t.length && (this.index = 0), t.length)
          ) {
        ...
        (w.prototype.getDummyImageContent = function (t, e, i) {
          ...
          if ((this.settings.dynamic || (s = x(this.items).eq(e)), s)) {
            var n = void 0;
            if (
              !(n = this.settings.exThumbImage ? s.attr(this.settings.exThumbImage) : s.find("img").first().attr("src"))
            )
              return "";
            var o =
              "<img " +
        ...
        (w.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            x(window).on("mousemove.lg.global" + this.lgId, function (o) {
              s &&
                t.lgOpened &&
                ((n = !0), (i = { pageX: o.pageX, pageY: o.pageY }), t.touchMove(e, i), t.LGel.trigger(m));
            }),
